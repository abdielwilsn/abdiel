        ...
        {experiences.map((exp) => (
          ...
          >
            <div className="flex flex-col h-full">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {exp.href ? (
                    <a
                      ...
                      className="text-primary hover:underline text-sm mt-1 inline-block break-words"
                    >
                      {exp.company}
                    </a>
                  ) : (
                    <p className="text-sm opacity-80 mt-1 break-words">{exp.company}</p>
                  )}
                </div>
                <div className="text-right text-sm opacity-70 whitespace-nowrap flex-shrink-0">
                  {exp.period}
                  {exp.location && (
              ...
              {exp.description && (
                <p className="text-sm opacity-80 leading-relaxed mt-auto break-words line-clamp-4">
                  {exp.description}
                </p>
              )}
            </div>
